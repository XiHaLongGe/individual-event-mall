    ...
    <form id="editFORM" class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" disabled="disabled" id="L_email" required lay-verify="account"
...
<script>
    ...
    function editAjax(){
        var yn = false;
        $.ajax({
            url:"/backend/customer/login/update",
            type:"POST",
