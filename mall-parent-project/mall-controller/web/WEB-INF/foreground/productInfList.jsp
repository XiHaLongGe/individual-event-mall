...
<div class="Xcontent">
    <ul class="Xcontent01">
        <div id="firstPicDIV" class="Xcontent06"><img src="/static/home/product-inf-list/images/shangpinxiangqing/X1.png"></div>
...
<script src="/static/home/product-inf-list/js/productBuy.js?v=<%= System.currentTimeMillis()%>"></script>
</body>
</html>