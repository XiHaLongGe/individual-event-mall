...
<head>
    ...
    <title>锡货超市</title>
    <link href="/static/home/submit-order/css/public.css?v=<%= System.currentTimeMillis()%>" type="text/css" rel="stylesheet"/>
    <link rel="stylesheet" type="text/css" href="/static/home/submit-order/css/base.css?v=<%= System.currentTimeMillis()%>"/>
    <script type="text/javascript" src="/static/home/submit-order/js/jquery_cart.js?v=<%= System.currentTimeMillis()%>"></script>
    <link rel="stylesheet" type="text/css" href="/static/home/submit-order/css/checkOut.css?v=<%= System.currentTimeMillis()%>" />
    <script src="/static/home/submit-order/js/jquery-1.11.1.min.js"></script>
</head>
        ...
        <ul class="fl 1h">
            <li class="fl">
                <div class="menu">
                    <div class="menu_hd">
                        <a href="#">
                            <img src="/static/home/submit-order/images/top_phone_icon.png" width="12px" height="16px" />
                            手机锡货
                        </a>
                        <b><em></em></b></div>
                    <div class="menu_bd">
...
<div class="header_2013">
    <div class="w">
        <div class="logo_v2013">
            <a href="#">
                <img class="border_r" src="/static/home/submit-order/images/logo.jpg" width="120" height="50">
                <img src="/static/home/submit-order/images/slogan.jpg" width="170" height="50">
            </a>
        </div>
        ...
        <div id="cart_box" class="cart_box">
            <a id="cart" class="cart_link" href="#" rel="nofollow">
                ...
                <img src="/static/home/submit-order/images/shopping_icon.png" width="24" height="24" class="cart_gif">
                        ...
                        <div class="cart_con_single">
                            <div class="single_pic">
                                <a href="#" target="_blank" alt="兰蔻 (Lancome)根源补养洁颜啫哩 125ml">
                                    <img src="/static/home/submit-order/images/goods_img01.jpg" />
                                </a>
                            </div>
                ...
                <div class="checkout-box-bd">
                    ...
                    <div class="xm-box">
                        ...
                        <div class="box-bd">
                            ...
                            <input type="hidden" name="customerInfId" value="1">
...
<%--                                                <input type="text" name="userAddress[consignee]" id="Consignee" class="input" placeholder="收货人姓名" maxlength="15" autocomplete='off'>--%>
                                            <input type="text" name="receivingInfName" value="嘻哈" id="Consignee" class="input" placeholder="收货人姓名" maxlength="10" autocomplete='off'>
                                        <p class="tip-msg tipMsg"></p>
                                    </div>
                                    <div class="item">
                                        <label>联系电话<span>*</span></label>
<%--                                            <input type="text" name="userAddress[tel]" class="input" id="Telephone" placeholder="11位手机号" autocomplete='off'>--%>
                                        <input type="text" name="receivingInfPhone" value="18707960607" class="input" id="Telephone" placeholder="11位手机号" maxlength="11" autocomplete='off'>
...
<%--                                            <textarea name="userAddress[street]" class="input-area" id="Street" placeholder="路名或街道地址，门牌号"></textarea>--%>
                                        <textarea name="receivingInfAddress" data-value="奥兰多就是啦看风景" class="input-area" id="Street" placeholder="路名或街道地址，门牌号"></textarea>
                                        <p class="tip-msg tipMsg"></p>
                                    </div>
                                    <div class="item">
                                        <label>邮政编码<span>*</span></label>
<%--                                            <input type="text" name="userAddress[zipcode]" id="Zipcode" class="input" placeholder="邮政编码"  autocomplete='off'>--%>
                                        <input type="text" name="postalCode" id="Zipcode" class="input" placeholder="邮政编码"  autocomplete='off'>
...
<%--                                            <input type="text" name="userAddress[tag]" id="Tag" class="input" placeholder='地址标签：如"家"、"公司"。限5个字内'  >--%>
                    ...
                    <!-- 收货地址 END-->
                    <script src="/static/home/submit-order/js/receiving_inf.js?v=<%= System.currentTimeMillis()%>"></script>
    ...
    <script type="text/javascript" src="/static/home/submit-order/js/address_all.js"></script>
    <script type="text/javascript" src="/static/home/submit-order/js/checkout.min.js"></script>
</div>
...
<%--<div class="promise_box">
    <div class="w">
        <ul>
            <li><img src="/static/home/submit-order/images/promise_img01.jpg"><span>365天不打烊</span></li>
            <li><img src="/static/home/submit-order/images/promise_img02.jpg"><span>无理由退换货</span></li>
            <li><img src="/static/home/submit-order/images/promise_img03.jpg"><span>担保交易</span></li>
            <li><img src="/static/home/submit-order/images/promise_img04.jpg"><span>先行赔付</span></li>
            <li><img src="/static/home/submit-order/images/promise_img05.jpg"><span>支持定制</span></li>
        </ul>
    </div>
</div>
<div class="bottom-links">
    <ul class="clearfix cols">
        ...
        <li class="col">
            ...
            <ul class="clearfix bottom-links-items">
                <li>
                    <img src="/static/home/submit-order/images/weixin_big.jpg" />
                </li>
            </ul>
        </li>
        <li class="col">
            ...
            <ul class="clearfix bottom-links-items">
                <li><img src="/static/home/submit-order/images/icon_sina.png" /><a href="#">新浪微博</a></li>
                <li><img src="/static/home/submit-order/images/icon_tencent.png" /><a href="#">腾讯微博</a></li>
                <li><img src="/static/home/submit-order/images/icon_dou.png" /><a href="#">豆瓣小站</a></li>
                <li><img src="/static/home/submit-order/images/icon_weixin.png" /><a href="#">官方微信</a></li>
            </ul>
        </li>
...
<div class="footer_v2013 bottom-about">
    ...
    <p>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img01.png"></a>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img02.png"></a>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img03.png"></a>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img04.png"></a>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img05.png"></a>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img06.png"></a>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img07.png"></a>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img08.png"></a>
        <a href="#"><img src="/static/home/submit-order/images/bottom_img09.png"></a>
    </p>
</div>
<!-- 底部 -->
<div class="fixed-buttons">
    <ul>
        <li><a href="#" class="fixed-weixin"><img src="/static/home/submit-order/images/fixed_weixin.png" /><div class="weixin-pic"><img src="/static/home/submit-order/images/weixin_big.jpg"></div></a></li>
        <li><img id="imgBtn-to-top" src="/static/home/submit-order/images/back_top.png" /></li>
    </ul>
</div>--%>
<script src="/static/home/submit-order/js/unslider.min.js?v=<%= System.currentTimeMillis()%>" type="text/javascript"></script>
<script src="/static/home/submit-order/js/index.js?v=<%= System.currentTimeMillis()%>" type="text/javascript"></script>
